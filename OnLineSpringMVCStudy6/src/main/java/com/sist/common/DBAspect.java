...
public class DBAspect {
	...
	@AfterThrowing(value="execution(* com.sist.board.dao.BoardDAO.board*(..))||execution(* com.sist.board.dao.BoardDAO.reply*(..))",throwing="ex") // AOP로 Catch절 수행
	...
	public void aftherReturing(Object obj)
	{
